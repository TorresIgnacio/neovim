...
function M.remove_background()
  ...
  vim.api.nvim_command("hi StatusLine guibg=none<CR>")
  vim.api.nvim_command("hi StatusLineNC guibg=none<CR>")
  vim.api.nvim_command("hi NormalSB guibg=none<CR>")
  vim.api.nvim_command("hi SignColumn guibg=none<CR>")
  vim.api.nvim_command("hi SignColumnSB guibg=none<CR>")
  vim.api.nvim_command("hi FoldColumn guibg=none<CR>")

  -- Make gray colors lighter
  -- local gray_color = "#ff0000"
  -- vim.api.nvim_command("hi NonText guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi StatusLineNC guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi Whitespace guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi WinBarNC guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi Comment guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi CmpItemKindText guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi CmpItemAbbrDeprecated guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi NoiceLspProgressClient guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi NvimTreeIndentMarker guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi NvimTreeGitStaged guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi NvimTreeRootFolder guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi NvimTreeGitNew guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi NvimTreeGitDirty guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi DiagnosticSource guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi LspCodeLens guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi qfLineNr guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi NvimTreeGitDeleted guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi DashboardShortCut guifg="..gray_color.."<CR>")
  -- vim.api.nvim_command("hi LazyProgressTodo guifg="..gray_color.."<CR>")
